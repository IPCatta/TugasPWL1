<?php
// Form edit barang (versi sederhana)
...
$barang = $result ? mysqli_fetch_assoc($result) : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nama_barang === '' || $kategori === '') {
        ...
        $cek = mysqli_query($koneksi, "SELECT id FROM barang WHERE kode_barang = '$kode_esc' AND id != $id");
    ...
    // Refresh data barang setelah update / error
    $result = mysqli_query($koneksi, "SELECT * FROM barang WHERE id = $id");
    $barang = $result ? mysqli_fetch_assoc($result) : $barang;
}
?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="harga" name="harga" 
                                       value="<?php echo number_format($barang['harga'], 0, ',', '.'); ?>" required
